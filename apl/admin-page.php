...
{
	/**
	 * The handler that controls the admin page.
	 * @var  APL_Handler
	 */
	protected $handler;

	/**
	 * The parent admin menu's name (eg. "themes.php") or APL_AdminMenu object.
	 * @var  string|APL_AdminMenu
	 */
	protected $menu;
	
	/**
	 * The name/slug of the page.
	 * @var  string
	 */
	public $name;
	...
	/**
	 * The capability needed to displayed to the user.
	 * @var string
	 */
	public $capability;
	
	/**
	 * True if this page is the main menu page.
	 * @var  bool
	 */
	public $is_main_page;

	/**
	 * True if this is current page being shown.
	 * @var  bool
	 */
	public $is_current_page;
	
	/**
	 * The page's tabs, if any.
	 * @var  Array
	 */
	protected $tabs;

	/**
	 * The names of the tabs with their index within the $tabs array (for searching purposes).
	 * @var  Array
	 */
	protected $tab_names;
	
	/**
	 * True if use the apl's custom Settings API.
	 * @var  bool
	 */
	public $use_custom_settings;

	/**
	 * All settings that have been registered.
	 * @var  Array
	 */
	protected $settings;
	
	/**
	 * True if the tab list should be displayed.
	 * @var  bool
	 */
	public $display_page_tab_list;
	
	/**
	 * An array of screen options.
	 * @var  Array
	 */
	public $screen_options;

	/**
	 * An array of columns that are selectable.
	 * @var  Array
	 */
	public $selectable_columns;
	
	/**
	 * A list of notices generated by the page.
	 * @var  Array
	 */
	protected $notices;

	/**
	 * A list of errors generated by the page.
	 * @var  Array
	 */
	protected $errors;
	 ...
	 * @param  array|null  $form_classes  The classes of the forms that should be processed via AJAX individually.  If no form is given, then current form is assumed.
	 * @param  array|null  $input_names  The names of the form input values to process via AJAX together.  If no input values are given, then the entire form will be processed.
	 * @param  string|null  $cb_start  The JS function to call when processing begins, before the first loop.
	 * @param  string|null  $cb_end  The JS function to call when processing finishes, after the last loop.
	 * @param  string|null  $cb_loop_start  The JS function to call when each form begins processing.
	 * @param  string|null  $cb_loop_end  The JS function to call when each formatOutput finishes processing.
	 */
