...
{
	/**
	 * The parent admin page that contains the tab.
	 * @var  APL_AdminPage
	 */
	protected $page;

	/**
	 * True if this is current tab being shown.
	 * @var  bool
	 */
	protected $is_current_tab;
	
	/**
	 * True if tab should appear in tab list, else False.
	 * @var  bool
	 */
	public $display_tab;
